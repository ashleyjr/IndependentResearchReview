...
These high intensity regions may be organs walls or bones but should also include potential tumours.
...
As all dimensions must be considered the differencing is just extended to the third dimension as shown in fig~\ref{fig:sobel}.
Smaller filter masks are also available to reduce computation.
...
Some tumours, fig.~\ref{fig:exBrain}, grow spherically meaning the ease of fitting sphere using GHT may be a useful feature for classification.

\subsection{Active Contours}

Active contours are a flexible methods for shape extraction.
...
Tumour features for extraction have been considered in section~\ref{sec:tumour} which already makes better use of data. 
