...
The GHT has been successfully applied to 3D images but as the shape of tumors are often unknown fitting a shape becomes redundant. 
Some tumors, fig.~\ref{fig:exBrain}, grow spherically meaning the ease of fitting sphere using GHT may be a useful feature for classification.
...
AdaBoost is the most common implementation of a boosting algorithm~\cite{freund99boost} and has been successfully applied to brain tumor classification in~\cite{islam13multi}.
